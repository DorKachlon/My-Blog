...
import timeFunc from "../helpers/timeFunc";

import "../styles/Comments.css";

export default function Comments() {
  const [comments, setComments] = useState([
    { name: "Alexey Ryadov", time: "29.06.2018 20:22", body: "good job" },
    { name: "Nir Fainshtein", time: "29.06.2020 20:22", body: "fainir fainir fainir" },
  ]);
  const name = useRef();
  const body = useRef();
  ...
  return (
    <div className="commentsContainer">
      ...
      <div className="newCommentContainer">
        ...
        />
        <textarea ref={body} className="newCommentBody" placeholder="Add to the discussion" />
